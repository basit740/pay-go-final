...
const Index = () => {
	return (
		<article className='capitalize px-24 py-20 mb-48 flex items-center justify-center overflow-hidden w-full object-cover bg-neutral-700 rounded-3xl h-96 bg-center bg-cover bg-no-repeat bg-blend-overlay bg-hero'>
			<h1 className='text-white text-5xl text-center font-medium leading-snug'>
				Welcome to{' '}
				<span className='text-green-primary capitalize'>pay go charge</span> ,
				the simple way to charge our electric vehicle. just add credits to start
				the charger.
			</h1>
		</article>
	);
